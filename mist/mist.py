...
from sysMonitor import (RES_CPU, RES_ETH, RES_HOSTS, RES_RAM, RES_TRAFFIC,
                        RES_WIFI, interfaces)
...
class mistGUI(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.bitmap_button_play = wx.BitmapButton(
            self, -1, wx.Bitmap(path.join(paths.ICONS, u"play.png"), wx.BITMAP_TYPE_ANY))
        self.bitmap_button_check = wx.BitmapButton(
            self, -1, wx.Bitmap(path.join(paths.ICONS, u"check.png"), wx.BITMAP_TYPE_ANY))
        self.bitmap_logo = wx.StaticBitmap(
            self, -1, wx.Bitmap(path.join(paths.ICONS, u"logo_misurainternet.png"), wx.BITMAP_TYPE_ANY))
        ...
        self.bitmap_cpu = wx.StaticBitmap(
            self, -1, wx.Bitmap(path.join(paths.ICONS, u"%s_gray.png" % RES_CPU.lower()), wx.BITMAP_TYPE_ANY))
        self.bitmap_ram = wx.StaticBitmap(
            self, -1, wx.Bitmap(path.join(paths.ICONS, u"%s_gray.png" % RES_RAM.lower()), wx.BITMAP_TYPE_ANY))
        self.bitmap_eth = wx.StaticBitmap(
            self, -1, wx.Bitmap(path.join(paths.ICONS, u"%s_gray.png" % RES_ETH.lower()), wx.BITMAP_TYPE_ANY))
        self.bitmap_wifi = wx.StaticBitmap(
            self, -1, wx.Bitmap(path.join(paths.ICONS, u"%s_gray.png" % RES_WIFI.lower()), wx.BITMAP_TYPE_ANY))
        # self.bitmap_hspa = wx.StaticBitmap(self, -1, wx.Bitmap(path.join(paths.ICONS, u"%s_gray.png" % RES_HSPA.lower()), wx.BITMAP_TYPE_ANY))
        self.bitmap_hosts = wx.StaticBitmap(
            self, -1, wx.Bitmap(path.join(paths.ICONS, u"%s_gray.png" % RES_HOSTS.lower()), wx.BITMAP_TYPE_ANY))
        self.bitmap_traffic = wx.StaticBitmap(
            self, -1, wx.Bitmap(path.join(paths.ICONS, u"%s_gray.png" % RES_TRAFFIC.lower()), wx.BITMAP_TYPE_ANY))
        ...
        # Messages area
        self.messages_area = wx.TextCtrl(self, -1, "", style=wx.TE_MULTILINE |
                                         wx.TE_READONLY | wx.TE_RICH2 | wx.TE_BESTWRAP | wx.BORDER_NONE)
        ...
        self.label_server_choice = wx.StaticText(self, -1, "Current measurement server:", style=wx.ALIGN_RIGHT)
        ...
        self.hbox_server_choice.Add(self.label_server_choice, 0, wx.ALIGN_CENTER_VERTICAL)
        self.hbox_server_choice.Add(self.text_server_choice, 0, wx.ALIGN_CENTER_VERTICAL)
    ...
    def __do_layout(self):
        ...
        self.grid_sizer_results.Add(self.label_ping, 0, wx.LEFT | wx.RIGHT |
                                    wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 44)
        self.grid_sizer_results.Add(self.label_download, 0, wx.LEFT | wx.RIGHT |
                                    wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 44)
        self.grid_sizer_results.Add(self.label_upload, 0, wx.LEFT | wx.RIGHT |
                                    wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 44)

        self.grid_sizer_results.Add(self.label_ping_result, 0, wx.ALL |
                                    wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 2)
        self.grid_sizer_results.Add(self.label_download_result, 0, wx.ALL |
                                    wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 2)
        self.grid_sizer_results.Add(self.label_upload_result, 0, wx.ALL |
                                    wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 2)
        ...
        self.sizer_results_and_status.Add(self.label_status, 0, wx.ALL |
        ...
        self.grid_sizer_system_indicators.Add(self.bitmap_cpu, 0, wx.LEFT | wx.RIGHT |
                                              wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 24)
        self.grid_sizer_system_indicators.Add(self.bitmap_ram, 0, wx.LEFT | wx.RIGHT |
                                              wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 24)
        self.grid_sizer_system_indicators.Add(self.bitmap_eth, 0, wx.LEFT | wx.RIGHT |
                                              wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 24)
        self.grid_sizer_system_indicators.Add(self.bitmap_wifi, 0, wx.LEFT |
                                              wx.RIGHT | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 24)
        ...
        self.grid_sizer_system_indicators.Add(self.bitmap_hosts, 0, wx.LEFT |
                                              wx.RIGHT | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 24)
        self.grid_sizer_system_indicators.Add(self.bitmap_traffic, 0, wx.LEFT |
                                              wx.RIGHT | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 24)

        self.grid_sizer_system_indicators.Add(self.label_cpu, 0, wx.LEFT | wx.RIGHT |
                                              wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 2)
        self.grid_sizer_system_indicators.Add(self.label_ram, 0, wx.LEFT | wx.RIGHT |
                                              wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 2)
        self.grid_sizer_system_indicators.Add(self.label_eth, 0, wx.LEFT | wx.RIGHT |
                                              wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 2)
        self.grid_sizer_system_indicators.Add(self.label_wifi, 0, wx.LEFT | wx.RIGHT |
                                              wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 2)
        ...
        self.grid_sizer_system_indicators.Add(self.label_hosts, 0, wx.LEFT |
                                              wx.RIGHT | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 2)
        self.grid_sizer_system_indicators.Add(self.label_traffic, 0, wx.LEFT |
                                              wx.RIGHT | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 2)

        self.sizer_results_frame.Add(self.sizer_results_and_status, 0, wx.ALL |
                                     wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 4)

        self.sizer_first_row.Add(self.bitmap_button_play, 0, wx.ALL |
                                 wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 4)
        self.sizer_first_row.Add(self.bitmap_button_check, 0, wx.ALL |
                                 wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 0)
        self.sizer_first_row.Add(self.sizer_results_frame, 0, wx.ALL |
                                 wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 4)
        # self.sizer_first_row.Add(self.sizer_results_and_status, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 4)
        self.sizer_first_row.Add(self.bitmap_logo, 0, wx.ALL |
                                 wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 8)

        self.sizer_messages_frame.Add(self.messages_area, 0, wx.ALL | wx.EXPAND |
                                      wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 0)
        self.sizer_system_indicators_frame.Add(self.grid_sizer_system_indicators,
                                               0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 8)
        self.sizer_servers_frame.Add(self.hbox_server_choice, 0, wx.ALL | wx.EXPAND |
                                     wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 8)
        ...
        self.sizer_root.Add(self.sizer_messages_frame, 0, wx.ALL |
                            wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 4)
        self.sizer_root.Add(self.sizer_system_indicators_frame, 0, wx.ALL |
                            wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 4)
        self.sizer_root.Add(self.sizer_servers_frame, 0, wx.ALL |
                            wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 4)
    ...
    def _on_size(self, event):
        ...
        self.sizer_messages_frame.SetMinSize(
            (W - width_margin, H - results_height - gauge_height - indicators_height - servers_height - (3 * width_margin) - extra))
        ...
        self.messages_area.SetMinSize((W - (2 * width_margin), H - results_height -
                                       gauge_height - indicators_height - servers_height - (4 * width_margin) - extra))
    ...
    def _killTester(self):
        if (self._tester and self._tester is not None):
            self._tester.join()
    ...
    def _after_check(self):
        self._update_messages("Profilazione terminata\n", 'green', font=(12, 93, 92, 1), fill=True)
        if (self._button_play):
            self._button_play = False
            self._button_check = False
            self._tester = SpeedTester(self, self._version, self._server_list[self.text_server_choice.GetSelection()])
            self._tester.start()
        else:
            # move_on_key()
            self._button_check = False
            self._update_interface(
                ">> PROFILAZIONE TERMINATA <<\nPremere PLAY per effettuare la misura", font=(12, 93, 92, 0))
            self._enable_button()
...
Premendo il tasto PLAY avvierai una profilazione e il test di misura completo.''' % (SWN, self._version)
        ...
        words = {word1: (wx.NullColour, wx.NullColour, font1), 'CHECK': (
            'blue', wx.NullColour, font2), 'PLAY': ('green', wx.NullColour, font2)}
