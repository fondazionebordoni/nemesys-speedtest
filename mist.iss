...
#define MyAppName "Misura Internet Speed Test"
...
Filename: {sys}\netsh.exe; Parameters: " firewall add allowedprogram ""{app}\dist\mist.exe"" ""MisuraInternetSpeedTest"" ENABLE CUSTOM 193.104.137.0/24 ALL"; Description: "Enable Misura Internet Speed Test traffic"; Flags: RunHidden RunAsCurrentUser; 
Filename: {sys}\netsh.exe; Parameters: " advfirewall firewall add rule name=""MisuraInternetSpeedTest"" dir=out action=allow program=""{app}\dist\mist.exe"" enable=yes"; Description: "Enable Misura Internet Speed Test traffic"; Flags: RunHidden RunAsCurrentUser; MinVersion: 0,6.1.7600; 
Filename: {app}\dist\mist.exe; Parameters: start; Description: "Avvia Misura Internet Speed Test"; Flags: PostInstall runmaximized RunAsCurrentUser; StatusMsg: "Avvia Misura Internet Speed Test";
