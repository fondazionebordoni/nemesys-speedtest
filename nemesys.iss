...
#define MyAppDir MyRoot + "\nemesys-speedtest\branches\client 1.0.4"
...
begin
  ...
  if RegValueExists(HKEY_LOCAL_MACHINE, 'SYSTEM\CurrentControlSet\Services\nm3','Start') then
    ...
    begin
      MsgBox('Installazione del software NeMeSys terminata poiché si è scelto di non installare le Microsoft Network Monitor',mbInformation, MB_OK);
      WizardForm.Close;
    end;
end;
